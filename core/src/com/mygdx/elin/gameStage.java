		...
		addActor(sceneLoader.getRoot());
			...
			//SpriteAnimation animation = 
					...
					//sceneLoader.getCompositeElementById("player").getBody().applyLinearImpulse(10, 0, sceneLoader.getCompositeElementById("player").getX(), sceneLoader.getCompositeElementById("player").getY(), true);
						...
						CompositeItem player2_ = sceneLoader.getRoot().getCompositeById("player2");
						CompositeItem ground2_ = sceneLoader.getRoot().getCompositeById("ground2");
					play play_ = new play(rs, sl, player2_, ground2_);
					sceneLoader.getRoot().getCompositeById("player").addScript(play_);
						...
						//Array<Fixture> player2_fixture = player2_.getBody().getFixtureList();
						//player2_fixture.first();
						...
						//sceneLoader.getRoot().getCompositeById("player2").addScript(play_);
